...
export const FETCHING_KADASTER_OBJECT_DATA = `${scope}/FETCHING_KADASTER_OBJECT_DATA`;
...
export const LOAD_KADASTER_OBJECT_DATA_NO_RESULTS = `${scope}/LOAD_KADASTER_OBJECT_DATA_NO_RESULTS`;
...
export const LOAD_KADASTER_SUBJECT_DATA_NO_RESULTS = `${scope}/LOAD_KADASTER_SUBJECT_DATA_NO_RESULTS`;
