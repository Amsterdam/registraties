...
describe('containers/MaatschappelijkeActiviteit/actions', () => {
  it('should dispatch loadData action', () => {
    ...
    expect(actions.loadData(payload)).toEqual({ type: constants.LOAD_DATA, payload: { maatschappelijkeActiviteitId } });
  });
