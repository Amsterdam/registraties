...
describe('containers/KadastraalObject', () => {
    ...
    const tree = mount(
      <Provider store={store}>
        <IntlProvider locale="nl" messages={messages}>
          <KadastraalObjectContainer />
        </IntlProvider>
      </Provider>,
    );
    const props = tree.find(KadastraalObjectContainerComponent).props();
  ...
  it('should render a Section component', () => {
    ...
    const { rerender } = render(
      <Provider store={store}>
        <IntlProvider locale="nl" messages={messages}>
          <KadastraalObjectContainerComponent intl={intlObj} />
        </IntlProvider>
      </Provider>,
    );
    ...
    rerender(
      <Provider store={store}>
        <IntlProvider locale="nl" messages={messages}>
          <KadastraalObjectContainerComponent intl={intlObj} status={LOAD_DATA_FAILED} />
        </IntlProvider>
      </Provider>,
    );
