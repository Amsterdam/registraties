...
export const KadastraalObjectContainerComponent = ({ data, intl, status }) => {
...
KadastraalObjectContainerComponent.propTypes = {
...
const Intl = injectIntl(KadastraalObjectContainerComponent);
