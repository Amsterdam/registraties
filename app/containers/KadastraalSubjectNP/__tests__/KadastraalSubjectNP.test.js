...
describe('containers/KadastraalSubjectNNP', () => {
    ...
    const tree = mount(
      <Provider store={store}>
        <IntlProvider locale="nl" messages={messages}>
          <KadastraalSubjectNPContainer />
        </IntlProvider>
      </Provider>,
    );
    const props = tree.find(KadastraalSubjectNPContainerComponent).props();
  ...
  it('should render a Section component', () => {
    ...
    const { rerender } = render(
      <Provider store={store}>
        <IntlProvider locale="nl" messages={messages}>
          <KadastraalSubjectNPContainerComponent intl={intlObj} />
        </IntlProvider>
      </Provider>,
    );
    ...
    rerender(
      <Provider store={store}>
        <IntlProvider locale="nl" messages={messages}>
          <KadastraalSubjectNPContainerComponent intl={intlObj} status={LOAD_DATA_FAILED} />
        </IntlProvider>
      </Provider>,
    );
