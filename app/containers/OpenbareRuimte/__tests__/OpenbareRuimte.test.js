...
describe('containers/OpenbareRuimte', () => {
    ...
    const tree = mount(
      <Provider store={store}>
        <IntlProvider locale="nl" messages={messages}>
          <OpenbareRuimteContainer />
        </IntlProvider>
      </Provider>,
    );
    const props = tree.find(OpenbareRuimteContainerComponent).props();
  ...
  it('should render a Section component', () => {
    ...
    const { rerender } = render(
      <Provider store={store}>
        <IntlProvider locale="nl" messages={messages}>
          <OpenbareRuimteContainerComponent intl={intlObj} />
        </IntlProvider>
      </Provider>,
    );
    ...
    rerender(
      <Provider store={store}>
        <IntlProvider locale="nl" messages={messages}>
          <OpenbareRuimteContainerComponent intl={intlObj} status={LOAD_DATA_FAILED} />
        </IntlProvider>
      </Provider>,
    );
