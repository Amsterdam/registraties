...
const containerScope = `${scope}/Pand`;
...
export const LOAD_LIST_DATA_FAILED = `${containerScope}/LOAD_LIST_DATA_FAILED`;
export const LOAD_LIST_DATA_NO_RESULTS = `${containerScope}/LOAD_LIST_DATA_NO_RESULTS`;
